        ...
        <table className="w-full text-[10px]">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50">
              ...
              <th className="text-center px-1 pl-8 py-2 font-semibold text-gray-500 whitespace-nowrap">Sat AM</th>
              ...
              <th className="text-center px-1 pl-8 py-2 font-semibold text-gray-500">Bir</th>
          ...
          <tbody>
            {stats.map((s, i) => (
              <tr key={i} className="border-b border-gray-50 last:border-0">
                ...
                <td className="text-center px-1 pl-8 py-2 font-medium" style={{ color: s.color }}>{cell(s.byRound[0])}</td>
                ...
                <td className="text-center px-1 pl-8 py-2 font-medium" style={{ color: s.color }}>{s.birdies || '—'}</td>
